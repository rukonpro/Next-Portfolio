...
import HowToConnectionOfMongooseInNodeJs from "@/app/components/views/blogs/Articls/How_to_Connection_of_Mongoose_in_Node_Js";
import Whats_Is_Features_In_Javascript_EE6 from "@/app/components/views/blogs/Articls/Whats_Is_Features_In_Javascript_EE6";
import The_different_ways_to_define_a_function_in_JavaScript
    from "@/app/components/views/blogs/Articls/The_different_ways_to_define_a_function_in_JavaScript";
import HowToDuplicateGitRepository from "@/app/components/views/blogs/Articls/HowToDuplicateGitRepository";
import WhatIsExpressJsAAndWhyWouldWeUseItBanner from "@/public/BlogsImage/WhatIsExpressJsAAndWhyWouldWeUseItBanner.png";
import WhatIsExpressJsAAndWhyWouldWeUseIt from "@/app/components/views/blogs/Articls/WhatIsExpressJsAAndWhyWouldWeUseIt";
import WhatIsAnAPIBanner1 from "@/public/BlogsImage/WhatIsAnAPIBanner1.png";
import WhatIsAnApi from "@/app/components/views/blogs/Articls/WhatIsAnAPI";
import JsxAndStateProps from "@/app/components/views/blogs/Articls/JSX_and_State_Props";
import JsxAndStatePropsBanner1 from "@/public/BlogsImage/JsxAndStatePropsBanner1.png";
import HowToStartProgramingForBeginner from "@/app/components/views/blogs/Articls/HowToStartProgramingForBeginner";
...
const portfolioData = {
    ...
    portfolios:{
        title:"Portfolio",
        description:"Welcome to my portfolios! As a Full stack developer, I specialize in crafting dynamic and efficient web applications. Below are some key portfolios that showcase my skills and passion for creating seamless user experiences.",
        future:  [
            {
    ...
    pricing:{
        ...
        description:"I offer comprehensive Full stack development expertise to bring your portfolios to life. My service structure is designed to provide flexibility based on the scope and complexity of your needs.",
        future:[
            {
                name: "Hourly Rate",
                desc: "My standard hourly rate for Full stack development is 1200$. This includes:",
                price: 1200,
                isMostPop: true,
                features: [
            ...
            },
            {
                ...
                desc: 'If you need Full stack project guidance or explore new ventures, my $1999 consulting includes:',
                price: 1999,
                isMostPop: false,
                features: [
